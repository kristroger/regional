...
$description_heading = apply_filters( 'learn_press_single_course_description_heading', esc_html__( 'Course Description', 'universh' ), $course );
?>

<?php if ( $description_heading ) { ?>

	<h3 class="course-description-heading" id="learn-press-course-description-heading"><?php echo esc_html($description_heading); ?></h3>
