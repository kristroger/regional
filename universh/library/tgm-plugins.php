...
function universh_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => esc_url('http://woodtheme.com/universh/plugins/universh-shortcodes.zip'), // The plugin source.
		...
		// This is an example of how to include a plugin bundled with a theme.
		array(
			'name'               => esc_html__('WPBakery Visual Composer', 'universh'), // The plugin name.
			'slug'               => 'js_composer', // The plugin slug (typically the folder name).
			'source'             => esc_url('http://woodtheme.com/universh/plugins/js_composer.zip'), // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		...
		array(
			...
			'source'             => esc_url('http://woodtheme.com/universh/plugins/revslider.zip'), // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		...
		array(
			'name'      => esc_html__('OptionTree', 'universh'),
			'slug'      => 'option-tree',
			'required'  => true,
		),
		...
		// This is an example of how to include a plugin from the WordPress Plugin Repository.
		array(
			'name'      => esc_html__('WP User Avatar', 'universh'),
			'slug'      => 'wp-user-avatar',
			'required'  => true,
		),
		...
		// This is an example of how to include a plugin from the WordPress Plugin Repository.
		array(
			'name'      => esc_html__('Event Tickets', 'universh'),
			'slug'      => 'event-tickets',
			'required'  => true,
		),
		...
		// This is an example of how to include a plugin from the WordPress Plugin Repository.
		array(
			'name'      => esc_html__('Black Studio TinyMCE Widget', 'universh'),
		...
		// This is an example of how to include a plugin from the WordPress Plugin Repository.
		array(
			'name'      => esc_html__('Background Videos for Visual Composer', 'universh'),
			'slug'      => 'background-videos-for-visual-composer',
			'required'  => true,
		),
