    ...
    <?php endif; ?>
            ...
            <div class="blog-img-wrap">
                ...
                <blockquote>        
                    ...
                    <footer>
                        <cite title="<?php echo esc_attr($source_title); ?>">
                        <a href="<?php echo (is_single())? esc_url($source_url) : esc_url(get_permalink()); ?>"><?php echo esc_html($source_name); ?>, <?php echo esc_html($source_date); ?></a>
                        </cite>            
                    </footer>            
                </blockquote>        			
                <?php endif; ?>
                ...
                <h6 class="post-type bg-yellow">&nbsp;<i class="fa fa-quote-left"></i>&nbsp;</h6>
                <?php endif; ?>
            </div><!-- Blog Wraper -->
            <!-- Blog Detail Wrapper -->
            <?php if(is_single()): ?>
